...
`}}}},render(r){return e.jsxs(e.Fragment,{children:[e.jsx(i,{...r,type:"solid",children:"Solid"}),e.jsx(i,{...r,type:"dashed",children:"Dashed"}),e.jsx(i,{...r,type:"dotted",children:"Dotted"})]})}},o={name:"線條方向-垂直",argTypes:{direction:{table:{disable:!0}},align:{table:{disable:!0}}},args:{},decorators:[r=>e.jsx("div",{style:{display:"flex",height:"100px"},children:e.jsx(r,{})})],parameters:{docs:{source:{transform(r,n){return`
...
}`,...(u=(m=d.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};var y,S,C;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: '線條類型',
  argTypes: {
    type: {
      table: {
...
}`,...(C=(S=s.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};var b,j,w;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: '線條方向-垂直',
  argTypes: {
    direction: {
      table: {
