import{j as e}from"./jsx-runtime-DEdD30eg.js";import"./tooltip-DgASWAb2.js";import"./badge-BPltvF_h.js";import"./breadcrumb-Enzkfzkv.js";import{T as B,B as l}from"./toast-B9iSJgcc.js";import"./checkbox-CclvOjyM.js";import"./progress-circle-5ZOi_8dX.js";import"./progress-line-2T3fy2De.js";import"./divider-DxMrCkxg.js";import"./grid-D9dEAlnk.js";import"./image-B9gne3T0.js";import"./input-DkyNJO7y.js";import"./layout-DgebEeDV.js";import"./menu-OxJg-HeI.js";import"./radio-CMOPLxLt.js";import"./status-indicator-BDww4a8h.js";import"./tag-DCMC4mp8.js";import"./textarea-CO8Z8fZG.js";import{T as m}from"./title-BdHUK5iL.js";import"./toggle-Ck5Sa1oo.js";import{g as c}from"./string-BqrfsRv8.js";import{l as x,m as g,n as P,o as N,g as h,q as E}from"./warning-tri-D1DJJwhd.js";import{r as C}from"./index-RYns6xqu.js";import{R as O}from"./index-sbqOYYIm.js";import"./online-EmbACc0H.js";import"./check-BnJBHFpS.js";import"./useCounter-DpfJ3ATo.js";const D=()=>{const[i,t]=C.useState([]);C.useEffect(()=>{if(i.length===0)return;const n=[...i].sort((A,R)=>A.createdAt-R.createdAt)[0],r=setTimeout(()=>{n.duration!==0&&o(n.id)},n.duration);return()=>clearTimeout(r)},[i]);const a=C.useCallback(s=>{const n=Date.now();return t(r=>[...r,{...s,id:n,createdAt:n,themeColor:s.themeColor||"primary",prefix:s.prefix||null,title:s.title,content:s.content,duration:s.duration}]),n},[]),o=C.useCallback(s=>{t(n=>n.filter(r=>r.id!==s))},[]),d=C.useCallback(()=>i.length===0?null:O.createPortal(e.jsx("div",{className:"ded-toast-container",children:i.map(s=>e.jsx(B,{...s,onClose:()=>o(s.id)},s.id))}),document.body),[i,o]);return{addToast:a,ToastContainer:d}},le={title:"Component/Toast",component:B,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select",options:["primary","secondary","neutral","info","success","warning","error"]},table:{category:"PROPS"}},title:{description:"標題",table:{category:"PROPS"}},content:{description:"內容",table:{category:"PROPS"}},action:{description:"操作",table:{category:"PROPS"}},prefix:{description:"前綴",options:["SvgInfoCircle","SvgSuccessCircle","SvgWarningTri","SvgErrorCircle"],mapping:{SvgInfoCircle:e.jsx(x,{}),SvgSuccessCircle:e.jsx(g,{}),SvgWarningTri:e.jsx(P,{}),SvgErrorCircle:e.jsx(N,{})},table:{category:"PROPS"}},duration:{description:"持續時間",control:{type:"range",step:100,min:0,max:5e3},table:{category:"PROPS"}},className:{description:"客製化樣式",table:{category:"PROPS"}},onClose:{description:"關閉事件",table:{category:"EVENTS"}}},args:{themeColor:"success",onClose:()=>window.alert("close"),title:"Notification Title ",content:"Content",action:e.jsx("div",{onClick:()=>window.alert("action"),children:"Action"}),prefix:e.jsx(g,{width:18,height:18}),duration:500,className:""},parameters:{docs:{title:"Toast",description:{component:"通知訊息組件的呈現及說明。"},source:{transform(i,t){const{args:a}=t;return`
...
}`,...(y=($=u.parameters)==null?void 0:$.docs)==null?void 0:y.source}}};const ce=["Default","Type","Demo"];export{v as Default,u as Demo,p as Type,ce as __namedExportsOrder,le as default};
