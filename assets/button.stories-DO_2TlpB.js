...
`}}}},render(t){return r.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:"16px"},children:[r.jsx(n,{...t,variant:"filled",children:t.children}),r.jsx(n,{...t,variant:"ghost",children:t.children}),r.jsx(n,{...t,variant:"text",children:t.children})]})}},l={name:"主題色彩",args:{variant:"filled",prefix:r.jsx(c,{}),suffix:null,onClick:()=>d("onClick")("點擊事件"),className:""},parameters:{docs:{source:{transform(t,o){const{args:e}=o;return`
...
}`,...($=(b=l.parameters)==null?void 0:b.docs)==null?void 0:$.source}}};const Y=["Default","Additional","Shape","Theme"];export{s as Additional,i as Default,a as Shape,l as Theme,Y as __namedExportsOrder,X as default};
