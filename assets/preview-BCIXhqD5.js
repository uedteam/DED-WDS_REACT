import{P as b,a as v,s as M}from"./index-DSudfg4k.js";import{d as x}from"./index-DrFu-skq.js";const{global:B}=__STORYBOOK_MODULE_GLOBAL__;var g="backgrounds",{document:l,window:w}=B,S=()=>w.matchMedia("(prefers-reduced-motion: reduce)").matches,A=(r,e=[],a)=>{if(r==="transparent")return"transparent";if(e.find(n=>n.value===r))return r;let d=e.find(n=>n.name===a);if(d)return d.value;if(a){let n=e.map(i=>i.name).join(", ");M.warn(x`
    ...
    `},[t]);return v(()=>{let f=e.viewMode==="docs"?`addon-backgrounds-grid-docs-${e.id}`:"addon-backgrounds-grid";if(!i){k(f);return}L(f,$)},[i,$,e]),r()},O=[_,T],z={[g]:{grid:{cellSize:20,opacity:.5,cellAmount:5},values:[{name:"light",value:"#F8F8F8"},{name:"dark",value:"#333333"}]}},G={[g]:null};export{O as decorators,G as initialGlobals,z as parameters};
