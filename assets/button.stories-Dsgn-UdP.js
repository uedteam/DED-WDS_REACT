...
`}}}},render(t){return r.jsxs(r.Fragment,{children:[r.jsx(n,{...t,variant:"filled",children:t.children}),r.jsx(n,{...t,variant:"ghost",children:t.children}),r.jsx(n,{...t,variant:"text",children:t.children})]})}},c={name:"主題色彩",argTypes:{themeColor:{table:{disable:!0}}},args:{variant:"filled",prefix:r.jsx(l,{}),suffix:null,onClick:()=>u("onClick")("點擊事件"),className:""},parameters:{docs:{source:{transform(t,o){const{args:e}=o;return`
...
}`,...(y=(B=i.parameters)==null?void 0:B.docs)==null?void 0:y.source}}};var C,b,S;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: '外觀樣式',
  argTypes: {
    variant: {
      table: {
...
}`,...(S=(b=a.parameters)==null?void 0:b.docs)==null?void 0:S.source}}};var j,v,$;c.parameters={...c.parameters,docs:{...(j=c.parameters)==null?void 0:j.docs,source:{originalSource:`{
  name: '主題色彩',
  argTypes: {
    themeColor: {
      table: {
...
}`,...($=(v=c.parameters)==null?void 0:v.docs)==null?void 0:$.source}}};const rt=["Default","Additional","Shape","Theme"];export{i as Additional,s as Default,a as Shape,c as Theme,rt as __namedExportsOrder,tt as default};
