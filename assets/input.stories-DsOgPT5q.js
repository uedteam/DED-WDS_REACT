...
`}}},render(r){return e.jsxs("div",{children:[e.jsx(t,{...r,label:"Account"}),e.jsx(t,{...r,label:"Password",type:"password",prefix:e.jsx(u,{})}),e.jsx(t,{...r,label:"Account",hint:{error:"Error message",description:""}}),e.jsx(t,{...r,label:"Account",hint:{error:"",description:"Prompt message"}}),e.jsx(t,{...r,label:"Account",isDisabled:!0,hint:{error:"",description:"Prompt message"}})]})}};var i,n,c;s.parameters={...s.parameters,docs:{...(i=s.parameters)==null?void 0:i.docs,source:{originalSource:`{
  name: '預設項目',
  args: {},
  render(args) {
    return <Input {...args} />;
...
}`,...(d=(l=a.parameters)==null?void 0:l.docs)==null?void 0:d.source}}};const w=["Default","InputWithStatus"];export{s as Default,a as InputWithStatus,w as __namedExportsOrder,v as default};
